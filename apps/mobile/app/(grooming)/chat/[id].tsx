...
import { initFirebase, COLLECTIONS, RTDB_PATHS, uploadImage, joinChat } from '@junglapp/firebase';
...
export default function GroomingChatScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F8FAFC' }} edges={['top']}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, gap: 12, borderBottomWidth: 1, borderBottomColor: '#E5E7EB', backgroundColor: '#fff' }}>
        <TouchableOpacity onPress={() => router.replace('/(grooming)/chat' as any)}>
        ...
        {otherId && (
          <ReportBlockButton
            ...
            onBlocked={() => router.replace('/(grooming)/chat' as any)}
          />
        )}
      </View>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
                    ...
                    <View style={{ maxWidth: '75%', alignItems: isMe ? 'flex-end' : 'flex-start' }}>
                      ...
                      {msg.text ? (
                        <View style={{
                          ...
                          backgroundColor: isMe ? '#9333EA' : '#fff',
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#E5E7EB', gap: 8 }}>
          ...
          <TouchableOpacity
            style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: text.trim() ? '#9333EA' : '#E5E7EB', alignItems: 'center', justifyContent: 'center' }}
            onPress={() => sendMessage()}
            disabled={!text.trim()}
          >
